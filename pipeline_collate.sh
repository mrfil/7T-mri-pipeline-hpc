...
cat right_hippo_label.csv right_volumes.csv > right_hippo.csv
cat left_hippo_label.csv left_volumes.csv > left_hippo.csv
paste -d, left_hippo.csv right_hippo.csv > ${subject}_${session}_ashs_volumes.csv
rm left_hippo_label.csv
rm right_hippo_label.csv
rm right_hippo.csv
rm left_hippo.csv
...
#elif [[ "${subject}" == "sub-SUB924" ]];
#then
#debugging only, qsiprep may be the culprit!
