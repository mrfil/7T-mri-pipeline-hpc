...
then
	...
	cp ${projDir}/${sub}/${ses}/*/*Aspire_P_ke_gre*/DICOM/*dcm ${projDir}/bids/derivatives/swi/${subject}/${sesname}/
  	cp ${projDir}/${sub}/${ses}/*/*Aspire_M_ke_gre*/DICOM/*dcm ${projDir}/bids/derivatives/swi/${subject}/${sesname}/
